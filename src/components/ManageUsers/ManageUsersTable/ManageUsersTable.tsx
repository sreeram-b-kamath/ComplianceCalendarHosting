...
const ManageUsersTable: React.FC<{ fetchData: () => void }> = ({
  ...
  const fetchUsers = async () => {
    ...
    try {
      const response = await axios.get(
        `https://compliancecalendarbackendhosting.onrender.com/ManageUsers/${profileDetails.EmployeeId}`
      ); // Adjust API endpoint
  ...
  const handleDeleteUser = (id: number) => {
    ...
    axios
      .put(`https://compliancecalendarbackendhosting.onrender.com/ManageUsers/${id}?adminId=${profileDetails.EmployeeId}`)
      .then(() => {
